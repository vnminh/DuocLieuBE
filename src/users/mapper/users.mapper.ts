...
export class UsersMapper {
  ...
  static toResponseLoginDto(
    data: User,
    message: string = 'User đăng nhập thành công',
  ): ResponseLoginDto {
    return {
      message,
      data,
  ...
  static toResponseUpdateUserDto(
    data: User,
    message: string = 'User được cập nhật thành công',
  ): ResponseCreateUserDto {
    return {
      message,
      data,
  ...
  static toResponseForgotPasswordDto(
    verificationCode: VerificationCode,
    emailResponse: CreateEmailResponseSuccess,
    message: string = 'Email reset password được gửi thành công',
  ): ResponseForgotPasswordDto {
    return {
      message,
      data: {
  ...
  static toResponseVerifyCodeDto(
    data: User,
  ...
  static toResponseAllUserDto(
    data: User[],
    total: number,
    n_pages?: number,
    message: string = 'get all users successfully',
  ): ResponseAllUserDto {
    return {
      message,
      data: {
  ...
  static toResponseCreateManyUserDto(
    data: User[],
    message: string = 'Users được tạo mới thành công',
  ): ResponseCreateManyUserDto {
    return {
      message,
      data,
